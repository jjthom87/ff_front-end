...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_7__app_routing__["a" /* AppRouter */], __WEBPACK_IMPORTED_MODULE_8__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_8__angular_forms__["b" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */], __WEBPACK_IMPORTED_MODULE_4_ng2_charts__["ChartsModule"]],
            providers: [],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__course_course_component__ = __webpack_require__("../../../../../src/app/course/course.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__course_course_component__["a" /* CourseComponent */] }
];
...
// module
exports.push([module.i, ".chartjs-render-monitor {\n\theight: 100;\n\twidth: 100;\n}", ""]);
...
module.exports = "<div>\n\t<h1 class=\"jumbotron text-center\">FatFucks Weight Loss Contest</h1>\n    <div class=\"row\">\n        <table class=\"table table-dark striped col-md-4 col-md-offset-3\" style=\"width: 50%\">\n            <thead>\n                <tr>\n                    <th>Place</th>\n                \t<th>Name</th>\n                    <th>% Lost</th>\n                \t<th>Starting Weight</th>\n                    <th>Week 1<br>(Sept 1 - 8)</th>\n                    <th>Week 2<br>(Sept 9 - 16)</th>\n                    <th>Week 3<br>(Sept 17 - 24)</th>\n                </tr>\n            </thead>\n            <tbody *ngFor=\"let user of users; let i = index\">\n            \t<tr>\n                    <td>{{i + 1}}</td>\n            \t\t<td>{{user.name}}</td>\n                    <td>{{user.weight.pct}}</td>\n            \t\t<td>{{user.weight.start}}</td>\n                    <td>{{user.weight.weekOne}}</td>\n                    <td>{{user.weight.weekTwo}}</td>\n                    <td>{{user.weight.weekThree}}</td>\n            \t</tr>\n            </tbody>\n        </table>\n        <div class=\"col-md-6 col-md-offset-3\" style=\"height:650px;width:650px;\">\n            <canvas baseChart width=\"500\" height=\"400\"\n                        [datasets]=\"lineChartData\"\n                        [labels]=\"lineChartLabels\"\n                        [options]=\"lineChartOptions\"\n                        [colors]=\"lineChartColors\"\n                        [legend]=\"lineChartLegend\"\n                        [chartType]=\"lineChartType\"\n                        (chartHover)=\"chartHovered($event)\"\n                        (chartClick)=\"chartClicked($event)\"></canvas>\n        </div>\n    </div>\n    <div>\n        <input type=\"text\"/>\n    </div>\n</div>\n"
...
var CourseComponent = /** @class */ (function () {
    function CourseComponent(http) {
        ...
        this.lineChartLabels = ['Start', 'Week 1', 'Week 2', 'Week 3', 'Week 4', 'Week 5', 'Week 6', 'Week 7', 'Week 8', 'Week 9', 'Week 10', 'Week 11', 'Week 12'];
    ...
    //weekNum = 0;
    CourseComponent.prototype.populateFatties = function (res) {
        var _this = this;
        res.forEach(function (user) { return _this.users.push(user); });
        ...
        for (var i = 0; i < this.users.length; i++) {
            if (this.users[i].name === "Subaru Steve") {
                for (var j in this.users[i].weight) {
        ...
        this.users.sort(function (a, b) { return a.weight.pct - b.weight.pct; });
    };
    CourseComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get("https://floating-inlet-43356.herokuapp.com/api/fat-fucks").subscribe(function (res) {
            //console.log(res); 
            _this.populateFatties(res);
            console.log(_this.steveTWeights);
        });
    ...
    CourseComponent.prototype.randomize = function () {
    ...
    // events
    CourseComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    CourseComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
